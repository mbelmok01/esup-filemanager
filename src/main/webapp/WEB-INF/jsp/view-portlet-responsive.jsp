...
<c:set var="n">
  ...
  <!-- Framework CSS  GIP Recia  For a bug in Chrome, important to load css
    ...
    <link type="text/css" href="/esup-filemanager/css/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="/esup-filemanager/js/jQuery-1.11.1.min.js">
    </script>
    <script type="text/javascript" src="/esup-filemanager/css/bootstrap/js/bootstrap.min.js">
    </script>
    

    <jsp:include page="responsive-body.jsp" />
